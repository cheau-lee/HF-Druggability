...
def main():
    ...
    plot_clusters_2d(features_pca, results_combined['Cluster'], 'Hierarchical Clusters on Druggability Features')

    # Save the clustered results to a CSV file
    output_clustered_file_combined = f'/Users/cheaulee/Desktop/hfproject/DF/Hierarchical/dfgeneclusters_hierarchical.csv'
